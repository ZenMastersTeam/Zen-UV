...
Покроковий туторіал базового рівня призначений для вивчення основ створення UV координат за допомогою аддона Zen UV для моделей, призначених для використання в ігрових рушіях.
...
В ході туторіалу ви дізнаєтеся основні правила створення розгортки, навчитеся використовувати інструменти Zen UV для швидкої та комфортної роботи. Отримаєте базову інформацію про правила та рекомендації щодо створення UV координат для ігрових рушіїв.

В туторіалі розглянуто основні етапи які є оптимальними кроками для обробки будь-якої моделі.

- Підготовка моделі
- Початкова розгортка
- Перевірка початкової розгортки
