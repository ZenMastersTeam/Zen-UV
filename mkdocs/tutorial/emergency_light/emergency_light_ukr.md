...
!!! Warning
    Перш ніж продовжити, переконайтеся, що **Zen UV Core Library** встановлено.  
    Без цієї бібліотеки ви отримаєте спрощений результат стакування.  
    Інструкцію з встановлення можна знайти за посиланням:  
    [Встановлення Zen UV Core Library](https://zenmastersteam.github.io/Zen-UV/latest/installation/#zen-uv-core-library)
...
!!! Warning
    Для коректного запікання в UV area не повинно бути стаків або будь-яких оверлапів. Там мають залишитися тільки [Singles](../../stack.md/#singles) та [Primaries](../../stack.md/#primaries). Всі [Replicas](../../stack.md/#replicas) мають бути здвинуті в сторону на 1.0. Для цього зручно використати оператор [Unstack](../../stack.md/#unstack). Але цей процесс не є частиною данного туторіалу і це попередження створене просто для нагадування.
