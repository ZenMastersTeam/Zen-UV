...
appears in place of the "Download" button.
...
5. Для цього туторіала можна просто видалити текстуру з **UV Editor** оскільки в даному випадку вона не має практичного призначення. 
...
3. Ми отримали розділення де кожен дріт являє собою один острів, але розгортання не коректне. Давайте розгорнемо дроти самим швидким способом.
    ...
    !!! Tip
        У випадку розгортання проводів або інших подібних моделей дуже зручно користуватися опцією **Use Selected Edges** оператора **Quadrify** яку ми розглядали раніше. Таким чином ми отримаэмо розриви саме там де портрібно з першої спроби.
